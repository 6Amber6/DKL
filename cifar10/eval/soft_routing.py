"""
Evaluation for DKL Soft Routing Fusion model on CIFAR-10.
...
from cifar10.model.soft_routing_wrn import SoftRoutingFusion
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Eval DKL Soft Routing Fusion, same protocol as DKL eval.py')
    ...
    net = SoftRoutingFusion(m4, m6, a=args.route_a, b=args.route_b, T=args.route_T, margin=args.route_margin)
