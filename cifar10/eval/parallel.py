"""
Evaluation for DKL Parallel Fusion model on CIFAR-10.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Eval DKL Parallel Fusion, same protocol as DKL eval.py')
