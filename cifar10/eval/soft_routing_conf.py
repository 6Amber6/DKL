"""
Evaluation for DKL Soft Routing Confidence Fusion model on CIFAR-10.
...
from cifar10.model.soft_routing_wrn import SoftRoutingConfidenceFusion
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Eval DKL Soft Routing Confidence Fusion, same protocol as DKL eval.py')
    ...
    m4 = WRNWithEmbedding(depth=34, widen_factor=10, num_classes=5)
    m6 = WRNWithEmbedding(depth=34, widen_factor=10, num_classes=7)
    net = SoftRoutingConfidenceFusion(m4, m6, T=args.route_T, margin=args.route_margin)
